3784 / 5529 (68.4%) of formulae have a valid `license` stanza as of 2021-03-21 00:32:19 UTC.

824 / 5529 (14.9%) contain a deprecated license (usually `GPL-2.0` or `GPL-3.0`).
...
- [x] adns: `{:all_of=>["GPL-3.0-or-later", "LGPL-2.0-or-later"]}`
...
- [x] aircrack-ng: `{:all_of=>["GPL-2.0-or-later", "BSD-3-Clause", "OpenSSL"]}`
- [x] airshare: MIT
...
- [x] aliddns: MIT
- [ ] align: GPL-2.0 (deprecated) [[homepage](https://legacy.cs.indiana.edu/~kinzler/align/)] [head] [[stable](https://www.cs.indiana.edu/~kinzler/align/align-1.7.5.tgz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/align.rb)]
- [x] aliyun-cli: Apache-2.0
- [x] allegro: Zlib
- [x] allure: Apache-2.0
- [x] allureofthestars: `{:all_of=>["AGPL-3.0-or-later", "GPL-2.0-or-later", "OFL-1.1", "MIT", :cannot_represent]}`
- [x] alluxio: Apache-2.0
...
- [ ] alure [[homepage](https://kcat.tomasu.net/alure.html)] [head] [[stable](https://kcat.tomasu.net/alure-releases/alure-1.2.tar.bz2)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/alure.rb)]
...
- [ ] amtterm: GPL-2.0 (deprecated) [[homepage](https://www.kraxel.org/blog/linux/amtterm/)] [[head](https://git.kraxel.org/git/amtterm/)] [[stable](https://www.kraxel.org/releases/amtterm/amtterm-1.6.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/amtterm.rb)]
...
- [x] ansible-cmdb: GPL-3.0-or-later
- [x] ansible-lint: MIT
...
- [x] ansible@2.9: GPL-3.0-or-later
...
- [x] antlr4-cpp-runtime: BSD-3-Clause
- [x] antlr@2: ANTLR-PD
...
- [x] apachetop: BSD-3-Clause
- [x] apcupsd: GPL-2.0-only
...
- [x] apollo: Apache-2.0
- [x] apollo-cli: MIT
- [ ] app-engine-java [[homepage](https://cloud.google.com/appengine/docs/java/)] [head] [[stable](https://storage.googleapis.com/appengine-sdks/featured/appengine-java-sdk-1.9.83.zip)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/app-engine-java.rb)]
...
- [x] argyll-cms: AGPL-3.0-only
- [x] aria2: GPL-2.0-or-later
- [x] arm-linux-gnueabihf-binutils: GPL-3.0-or-later
...
- [x] arturo: MIT
- [x] arx-libertatis: GPL-3.0-or-later
- [x] as-tree: BlueOak-1.0.0
...
- [x] aspcud: MIT
- [ ] aspectj [[homepage](https://www.eclipse.org/aspectj/)] [head] [[stable](https://www.eclipse.org/downloads/download.php?r=1&file=/tools/aspectj/aspectj-1.9.6.jar)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/aspectj.rb)]
...
- [x] atk: GPL-2.0-or-later
- [x] atkmm: LGPL-2.1-or-later
- [x] atkmm@2.28: LGPL-2.1-or-later
- [x] atlantis: Apache-2.0
- [ ] atlassian-cli [[homepage](https://bobswift.atlassian.net/wiki/pages/viewpage.action?pageId=1966101)] [head] [[stable](https://bobswift.atlassian.net/wiki/download/attachments/16285777/atlassian-cli-9.6.0-distribution.zip)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/atlassian-cli.rb)]
- [x] atomicparsley: GPL-2.0-or-later
...
- [ ] autoconf-archive: GPL-3.0 (deprecated) [[homepage](https://savannah.gnu.org/projects/autoconf-archive/)] [head] [[stable](https://ftp.gnu.org/gnu/autoconf-archive/autoconf-archive-2021.02.19.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/autoconf-archive.rb)]
...
- [ ] bacula-fd [[homepage](https://www.bacula.org/)] [head] [[stable](https://downloads.sourceforge.net/project/bacula/bacula/11.0.1/bacula-11.0.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/bacula-fd.rb)]
- [x] badtouch: GPL-3.0-or-later
- [x] bagit: CC0-1.0
...
- [ ] bbftp-client [[homepage](https://software.in2p3.fr/bbftp/)] [head] [[stable](http://software.in2p3.fr/bbftp/dist/bbftp-client-3.2.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/bbftp-client.rb)]
...
- [ ] bitwarden-cli: GPL-3.0 (deprecated) [[homepage](https://bitwarden.com/)] [head] [[stable](https://registry.npmjs.org/@bitwarden/cli/-/cli-1.15.1.tgz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/bitwarden-cli.rb)]
...
- [ ] blazegraph [[homepage](https://www.blazegraph.com/)] [head] [[stable](https://github.com/blazegraph/database/releases/download/BLAZEGRAPH_RELEASE_2_1_5/blazegraph.jar)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/blazegraph.rb)]
...
- [x] bmon: BSD-2-Clause
- [ ] bnd [[homepage](https://bnd.bndtools.org/)] [head] [[stable](https://search.maven.org/remotecontent?filepath=biz/aQute/bnd/biz.aQute.bnd/5.3.0/biz.aQute.bnd-5.3.0.jar)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/bnd.rb)]
- [x] bnfc: BSD-3-Clause
...
- [x] bombadillo: GPL-3.0-or-later
- [x] bond: MIT
- [x] bonnie++: GPL-2.0-only
...
- [x] bsdmake: `{:all_of=>["BSD-2-Clause", "BSD-3-Clause", "BSD-4-Clause-UC"]}`
...
- [x] cairo: `{:any_of=>["LGPL-2.1-only", "MPL-1.1"]}`
- [x] cairomm: LGPL-2.0-or-later
- [x] cairomm@1.14: LGPL-2.0-or-later
- [x] cake: MIT
...
- [x] cargo-audit: Apache-2.0
- [x] cargo-c: MIT
- [x] cargo-edit: MIT
- [x] cargo-instruments: MIT
- [x] cargo-watch: CC0-1.0
- [x] carina: Apache-2.0
...
- [x] cgrep: GPL-2.0-or-later
- [x] cgvg: GPL-2.0-or-later
...
- [x] chapel: Apache-2.0
- [x] charge: MIT
- [ ] charm: GPL-3.0 (deprecated) [[homepage](https://github.com/juju/charmstore-client)] [head] [[stable](https://github.com/juju/charmstore-client/archive/v2.5.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/charm.rb)]
- [x] charm-tools: GPL-3.0-only
- [x] chars: MIT
...
- [ ] checkbashisms [[homepage](https://launchpad.net/ubuntu/+source/devscripts/)] [head] [[stable](https://deb.debian.org/debian/pool/main/d/devscripts/devscripts_2.21.1.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/checkbashisms.rb)]
...
- [x] clens: ISC
- [x] clfft: Apache-2.0
- [ ] clhep: GPL-3.0 (deprecated) [[homepage](https://proj-clhep.web.cern.ch/proj-clhep/)] [[head](https://gitlab.cern.ch/CLHEP/CLHEP.git)] [[stable](https://proj-clhep.web.cern.ch/proj-clhep/dist1/clhep-2.4.4.1.tgz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/clhep.rb)]
...
- [x] cloudflare-wrangler: `{:any_of=>["Apache-2.0", "MIT"]}`
...
- [x] coin3d: `{:all_of=>["BSD-3-Clause", "ISC"]}`
...
- [x] comby: Apache-2.0
- [x] commandbox: LGPL-3.0-or-later
- [x] commitizen: MIT
...
- [x] cpplint: Apache-2.0
- [x] cppman: GPL-3.0-or-later
...
- [x] crf++: `{:any_of=>["LGPL-2.1-only", "BSD-3-Clause"]}`
- [x] crispy-doom: GPL-2.0-only
...
- [x] csvq: MIT
- [x] csvtomd: MIT
- [x] ctags: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later"]}`
- [x] ctail: Apache-2.0
- [x] ctemplate: BSD-3-Clause
- [x] ctl: AMPAS
- [x] ctop: MIT
- [ ] cuba: LGPL-3.0 (deprecated) [[homepage](http://www.feynarts.de/cuba/)] [head] [[stable](http://www.feynarts.de/cuba/Cuba-4.2.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/cuba.rb)]
- [x] cubeb: ISC
...
- [x] cvs: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.0-or-later"]}`
...
- [ ] cweb [[homepage](https://cs.stanford.edu/~knuth/cweb.html)] [head] [[stable](https://cs.stanford.edu/pub/cweb/cweb-3.64c.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/cweb.rb)]
- [x] cwlogs: MIT
- [x] cxxopts: MIT
...
- [x] cyrus-sasl: BSD-3-Clause-Attribution
- [x] cython: Apache-2.0
- [x] czmq: MPL-2.0
...
- [x] dbhash: blessing
- [x] dbmate: MIT
- [ ] dbus [[homepage](https://wiki.freedesktop.org/www/Software/dbus)] [[head](https://gitlab.freedesktop.org/dbus/dbus.git)] [[stable](https://dbus.freedesktop.org/releases/dbus/dbus-1.12.20.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/dbus.rb)]
...
- [ ] dcmtk [[homepage](https://dicom.offis.de/dcmtk.php.en)] [[head](https://git.dcmtk.org/dcmtk.git)] [[stable](https://dicom.offis.de/download/dcmtk/dcmtk366/dcmtk-3.6.6.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/dcmtk.rb)]
...
- [x] ddd: `{:all_of=>["GPL-3.0-only", "GFDL-1.1-or-later"]}`
...
- [x] diamond: GPL-3.0-or-later
- [ ] diceware: GPL-3.0 (deprecated) [[homepage](https://github.com/ulif/diceware)] [head] [[stable](https://files.pythonhosted.org/packages/d7/af/85373be6b11706fa1392e52d7fcd47df47f661e238251c931d469e62c5bf/diceware-0.9.6.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/diceware.rb)]
...
- [x] dnsmasq: `{:any_of=>["GPL-2.0-only", "GPL-3.0-only"]}`
...
- [x] dnsviz: GPL-2.0-or-later
- [x] dnsx: MIT
- [x] docbook: `cannot_represent`
- [x] docbook-xsl: MIT
...
- [x] dovecot: `{:all_of=>["BSD-3-Clause", "LGPL-2.1-or-later", "MIT", "Unicode-DFS-2016", :public_domain]}`
...
- [x] dwarfutils: `{:all_of=>["BSD-2-Clause", "LGPL-2.1-or-later", "GPL-2.0-or-later"]}`
...
- [x] e2fsprogs: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.0-or-later", "LGPL-2.0-only", "BSD-3-Clause", "MIT"]}`
...
- [x] ems-flasher: MIT
- [x] emscripten: `{:all_of=>["Apache-2.0", {"Apache-2.0"=>{:with=>"LLVM-exception"}, :any_of=>["MIT", "NCSA"]}]}`
...
- [x] envoy: Apache-2.0
- [x] envv: MIT
- [x] enzyme: `{"Apache-2.0"=>{:with=>"LLVM-exception"}}`
- [x] eot-utils: W3C
- [x] epeg: MIT-enna
...
- [x] eprover: `{:any_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later"]}`
...
- [x] exenv: MIT
- [x] exercism: MIT
- [ ] exif: LGPL-2.1 (deprecated) [[homepage](https://libexif.github.io/)] [head] [[stable](https://github.com/libexif/exif/releases/download/exif-0_6_22-release/exif-0.6.22.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/exif.rb)]
...
- [x] extra-cmake-modules: `{:all_of=>["BSD-2-Clause", "BSD-3-Clause", "MIT"]}`
- [x] extract_url: BSD-2-Clause
- [x] exult: GPL-2.0-or-later
- [x] eye-d3: GPL-3.0-or-later
- [x] ezstream: GPL-2.0-only
...
- [x] fdupes: MIT
- [x] feedgnuplot: `{:any_of=>["GPL-1.0-or-later", "Artistic-1.0"]}`
- [x] feh: MIT-feh
- [x] fennel: MIT
- [x] fetch: MIT
- [x] fetch-crl: Apache-2.0
- [ ] fetchmail [[homepage](https://www.fetchmail.info/)] [head] [[stable](https://downloads.sourceforge.net/project/fetchmail/branch_6.4/fetchmail-6.4.17.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/fetchmail.rb)]
...
- [x] findent: BSD-3-Clause
- [x] findomain: GPL-3.0-or-later
- [x] findutils: GPL-3.0-or-later
- [x] fio: GPL-2.0-only
- [x] firebase-cli: MIT
- [x] fish: GPL-2.0-only
- [x] fits: Apache-2.0
...
- [x] forego: Apache-2.0
- [x] foreman: MIT
- [x] foremost: `public_domain`
- [x] forge: BSD-3-Clause
- [x] fork-cleaner: MIT
...
- [ ] fplll: LGPL-2.1 (deprecated) [[homepage](https://github.com/fplll/fplll)] [head] [[stable](https://github.com/fplll/fplll/releases/download/5.4.0/fplll-5.4.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/fplll.rb)]
- [x] fpp: MIT
...
- [x] frei0r: GPL-2.0-or-later
- [x] fribidi: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later"]}`
...
- [x] funcoeszz: GPL-2.0-only
- [x] functionalplus: BSL-1.0
- [x] fuse-emulator: GPL-2.0-or-later
...
- [x] gatsby-cli: MIT
- [x] gau: MIT
- [ ] gauche [[homepage](https://practical-scheme.net/gauche/)] [head] [[stable](https://github.com/shirok/Gauche/releases/download/release0_9_10/Gauche-0.9.10.tgz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/gauche.rb)]
- [x] gauge: Apache-2.0
...
- [x] gcalcli: MIT
- [x] gcc: `{"GPL-3.0-or-later"=>{:with=>"GCC-exception-3.1"}}`
...
- [x] geocode-glib: GPL-2.0-or-later
- [x] geogram: `{:all_of=>["BSD-3-Clause", :public_domain, "LGPL-3.0-or-later", "MIT"]}`
- [x] geographiclib: MIT
- [x] geoip: LGPL-2.1-or-later
- [x] geoipupdate: Apache-2.0
- [x] geomview: LGPL-2.1-only
- [ ] geos: LGPL-2.1 (deprecated) [[homepage](https://trac.osgeo.org/geos)] [head] [[stable](https://download.osgeo.org/geos/geos-3.9.1.tar.bz2)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/geos.rb)]
- [ ] geoserver [[homepage](http://geoserver.org/)] [head] [[stable](https://downloads.sourceforge.net/project/geoserver/GeoServer/2.18.2/geoserver-2.18.2-bin.zip)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/geoserver.rb)]
- [x] geph2: GPL-3.0-only
- [x] geph4: GPL-3.0-only
...
- [ ] get_iplayer: GPL-3.0 (deprecated) [[homepage](https://github.com/get-iplayer/get_iplayer)] [[head](https://github.com/get-iplayer/get_iplayer.git)] [[stable](https://github.com/get-iplayer/get_iplayer/archive/v3.27.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/get_iplayer.rb)]
...
- [x] git-interactive-rebase-tool: GPL-3.0-or-later
- [x] git-lfs: MIT
...
- [ ] git-remote-gcrypt: GPL-3.0 (deprecated) [[homepage](https://spwhitton.name/tech/code/git-remote-gcrypt/)] [head] [[stable](https://github.com/spwhitton/git-remote-gcrypt/archive/1.4.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/git-remote-gcrypt.rb)]
...
- [x] glibc: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later"]}`
- [x] glibmm: LGPL-2.1-or-later
- [x] glibmm@2.66: LGPL-2.1-or-later
- [x] glide: MIT
...
- [x] glow: MIT
- [x] glpk: GPL-3.0-or-later
- [ ] glslang [[homepage](https://www.khronos.org/opengles/sdk/tools/Reference-Compiler/)] [[head](https://github.com/KhronosGroup/glslang.git)] [[stable](https://github.com/KhronosGroup/glslang/archive/11.2.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/glslang.rb)]
- [x] glslviewer: BSD-3-Clause
- [x] glui: Zlib
- [x] glulxe: MIT
- [x] gluon: MIT
- [x] glyr: LGPL-3.0-or-later
...
- [x] gnome-autoar: LGPL-2.1-or-later
...
- [x] gnu-indent: GPL-3.0-or-later
- [x] gnu-prolog: `{:any_of=>["LGPL-3.0-or-later", "GPL-2.0-or-later"]}`
- [x] gnu-sed: GPL-3.0-or-later
...
- [x] gnu-tar: GPL-3.0-or-later
- [x] gnu-time: GPL-3.0-or-later
...
- [ ] graph-tool: LGPL-3.0 (deprecated) [[homepage](https://graph-tool.skewed.de/)] [head] [[stable](https://downloads.skewed.de/graph-tool/graph-tool-2.37.tar.bz2)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/graph-tool.rb)]
- [x] graphene: MIT
- [ ] graphicsmagick [[homepage](http://www.graphicsmagick.org/)] [[head](http://hg.code.sf.net/p/graphicsmagick/code)] [[stable](https://downloads.sourceforge.net/project/graphicsmagick/graphicsmagick/1.3.36/GraphicsMagick-1.3.36.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/graphicsmagick.rb)]
- [x] graphite2: `{:any_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later", "MPL-1.1+"]}`
- [x] graphql-cli: MIT
- [x] graphviz: EPL-1.0
- [x] gravity: MIT
- [x] grc: GPL-2.0-or-later
...
- [x] grip: MIT
- [x] groff: GPL-3.0-or-later
- [x] grok: BSD-2-Clause
- [x] grokj2k: AGPL-3.0-or-later
- [x] grokmirror: GPL-3.0-or-later
- [x] gromacs: LGPL-2.1-or-later
- [x] gron: MIT
...
- [x] gsasl: GPL-3.0-or-later
- [x] gsettings-desktop-schemas: LGPL-2.1-or-later
- [x] gsl: GPL-3.0-or-later
...
- [x] gtk-mac-integration: LGPL-2.1-only
...
- [x] gtkmm: LGPL-2.1-or-later
- [x] gtkmm3: LGPL-2.1-or-later
- [x] gtkmm4: LGPL-2.1-or-later
...
- [x] gtksourceviewmm: LGPL-2.1-or-later
- [x] gtksourceviewmm3: LGPL-2.1-or-later
...
- [x] gws: MIT
- [x] gwt: Apache-2.0
- [x] gwyddion: GPL-2.0-or-later
- [x] gx: MIT
- [x] gx-go: MIT
- [x] gxml: LGPL-2.1-or-later
- [x] gzip: GPL-3.0-or-later
...
- [x] handbrake: GPL-2.0-only
- [x] hapi-fhir-cli: Apache-2.0
- [x] haproxy: `{"GPL-2.0-or-later"=>{:with=>"openvpn-openssl-exception"}}`
...
- [x] hashlink: MIT
- [x] hashpump: MIT
- [x] haskell-language-server: Apache-2.0
- [x] haskell-stack: BSD-3-Clause
- [x] haste-client: MIT
- [x] hasura-cli: Apache-2.0
- [x] hatari: GPL-2.0-or-later
- [x] haxe: `{:all_of=>["GPL-2.0-or-later", "MIT"]}`
- [x] hayai: Apache-2.0
- [x] hbase: Apache-2.0
- [x] hblock: MIT
- [x] hcloud: MIT
...
- [ ] hdf5@1.8 [[homepage](https://www.hdfgroup.org/HDF5)] [head] [[stable](https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.8/hdf5-1.8.22/src/hdf5-1.8.22.tar.bz2)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/hdf5@1.8.rb)]
...
- [ ] hevea [[homepage](http://hevea.inria.fr/)] [head] [[stable](http://hevea.inria.fr/old/hevea-2.35.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/hevea.rb)]
...
- [x] hypre: `{:any_of=>["MIT", "Apache-2.0"]}`

### I

- [ ] i2p [[homepage](https://geti2p.net)] [head] [[stable](https://download.i2p2.de/releases/0.9.49/i2pinstall_0.9.49.jar)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/i2p.rb)]
- [x] i2pd: BSD-3-Clause
...
- [x] i686-elf-binutils: GPL-3.0-or-later
...
- [ ] igv [[homepage](https://www.broadinstitute.org/software/igv)] [head] [[stable](https://data.broadinstitute.org/igv/projects/downloads/2.8/IGV_2.8.13.zip)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/igv.rb)]
- [x] ii: MIT
- [x] ike-scan: GPL-3.0-or-later
- [x] ilmbase: BSD-3-Clause
- [x] imagejs: GPL-3.0-only
- [x] imagemagick: ImageMagick
- [x] imagemagick@6: ImageMagick
- [x] imageoptim-cli: MIT
- [x] imagesnap: `public_domain`
- [x] imageworsener: MIT
- [x] imake: MIT
...
- [x] immudb: Apache-2.0
- [x] inadyn: `{:all_of=>["GPL-2.0-or-later", "ISC", "MIT"]}`
- [x] include-what-you-use: NCSA
- [x] indicators: MIT
- [x] inetutils: GPL-3.0-or-later
- [x] infer: MIT
- [x] influxdb: MIT
...
- [x] inlets: MIT
- [x] innoextract: Zlib
- [x] innotop: `{:any_of=>["GPL-2.0-only", "Artistic-1.0-Perl"]}`
- [x] insect: MIT
- [x] inspectrum: GPL-3.0-or-later
...
- [x] ipfs: `{:all_of=>["MIT", {:any_of=>["MIT", "Apache-2.0"]}]}`
...
- [x] isl: MIT
- [x] isl@0.18: MIT
- [x] iso-codes: LGPL-2.1-or-later
- [x] isort: MIT
- [x] ispc: BSD-3-Clause
- [ ] ispell [[homepage](https://www.cs.hmc.edu/~geoff/ispell.html)] [head] [[stable](https://www.cs.hmc.edu/~geoff/tars/ispell-3.4.02.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/ispell.rb)]
- [x] istioctl: Apache-2.0
- [ ] isync: GPL-2.0 (deprecated) [[homepage](https://isync.sourceforge.io/)] [[head](https://git.code.sf.net/p/isync/isync.git)] [[stable](https://downloads.sourceforge.net/project/isync/isync/1.4.1/isync-1.4.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/isync.rb)]
...
- [x] kapacitor: MIT
- [x] karchive: `{:all_of=>["BSD-2-Clause", "LGPL-2.0-only", "LGPL-2.0-or-later", {:any_of=>["LGPL-2.0-only", "LGPL-3.0-only"]}]}`
- [x] karn: MIT
- [x] katago: MIT
...
- [x] kcptun: MIT
- [x] kdoctools: `{:all_of=>["BSD-3-Clause", "GPL-2.0-or-later", "LGPL-2.1-or-later", {:any_of=>["LGPL-2.1-only", "LGPL-3.0-only"]}]}`
- [x] kedge: Apache-2.0
- [x] keepassc: ISC
...
- [x] khiva: MPL-2.0
- [x] ki18n: `{:all_of=>["BSD-3-Clause", "LGPL-2.0-or-later", {:any_of=>["LGPL-2.1-only", "LGPL-3.0-only"]}]}`
- [x] kibana: Apache-2.0
...
- [x] ktlint: MIT
- [x] ktmpl: MIT
- [x] ktoblzcheck: LGPL-2.1-or-later
...
- [x] kyoto-cabinet: GPL-3.0-or-later
...
- [x] launch4j: `{:all_of=>["BSD-3-Clause", "MIT"]}`
...
- [x] leiningen: EPL-1.0
- [x] lemon: blessing
- [x] lensfun: `{:all_of=>["LGPL-3.0-only", "GPL-3.0-only", "CC-BY-3.0", :public_domain]}`
- [x] lepton: Apache-2.0
...
- [x] lesstif: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.0-or-later"]}`
...
- [x] libebml: LGPL-2.1-or-later
- [x] libebur128: MIT
- [ ] libedit [[homepage](https://thrysoee.dk/editline/)] [head] [[stable](https://thrysoee.dk/editline/libedit-20210216-3.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libedit.rb)]
...
- [x] libextractor: GPL-3.0-or-later
- [x] libfabric: `{:any_of=>["BSD-2-Clause", "GPL-2.0-only"]}`
- [x] libfaketime: GPL-2.0-only
...
- [x] libfreenect: `{:any_of=>["Apache-2.0", "GPL-2.0-only"]}`
- [x] libfs: MIT
- [x] libftdi: LGPL-2.1-only
...
- [x] libgda: GPL-2.0-or-later
- [x] libgdata: LGPL-2.1-or-later
- [ ] libgee: LGPL-2.1 (deprecated) [[homepage](https://wiki.gnome.org/Projects/Libgee)] [head] [[stable](https://download.gnome.org/sources/libgee/0.20/libgee-0.20.4.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libgee.rb)]
- [x] libgeotiff: MIT
...
- [x] libgnomecanvasmm: LGPL-2.1-or-later
- [ ] libgnt: GPL-2.0 (deprecated) [[homepage](https://keep.imfreedom.org/libgnt/libgnt)] [head] [[stable](https://downloads.sourceforge.net/project/pidgin/libgnt/2.14.1/libgnt-2.14.1.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libgnt.rb)]
- [x] libgosu: MIT
- [x] libgpg-error: LGPL-2.1-or-later
...
- [x] libidn2: `{:any_of=>["GPL-2.0-or-later", "LGPL-3.0-or-later"]}`
...
- [x] libiodbc: `{:any_of=>["BSD-3-Clause", "LGPL-2.0-only"]}`
...
- [x] libksba: `{:any_of=>["LGPL-3.0-or-later", "GPL-2.0-or-later"]}`
...
- [x] liblockfile: LGPL-2.0-or-later
...
- [ ] libmatroska: LGPL-2.1 (deprecated) [[homepage](https://www.matroska.org/)] [[head](https://github.com/Matroska-Org/libmatroska.git)] [[stable](https://dl.matroska.org/downloads/libmatroska/libmatroska-1.6.3.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libmatroska.rb)]
- [x] libmaxminddb: Apache-2.0
- [x] libmd: BSD-3-Clause
...
- [x] libmetalink: MIT
- [x] libmicrohttpd: LGPL-2.1-or-later
...
- [x] libmill: MIT
- [x] libming: `{:all_of=>["LGPL-2.1-or-later", "GPL-2.0-or-later"]}`
...
- [ ] libngspice [[homepage](https://ngspice.sourceforge.io/)] [[head](https://git.code.sf.net/p/ngspice/ngspice.git)] [[stable](https://downloads.sourceforge.net/project/ngspice/ng-spice-rework/34/ngspice-34.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libngspice.rb)]
- [x] libnice: `{:any_of=>["LGPL-2.1-only", "MPL-1.1"]}`
...
- [x] libodfgen: `{:any_of=>["MPL-2.0", "LGPL-2.1-or-later"]}`
- [ ] libofx: GPL-2.0 (deprecated) [[homepage](https://libofx.sourceforge.io)] [head] [[stable](https://downloads.sourceforge.net/project/libofx/libofx/libofx-0.10.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libofx.rb)]
...
- [x] libpinyin: GPL-3.0-or-later
- [x] libpipeline: GPL-3.0-or-later
...
- [x] libproxy: LGPL-2.1-or-later
- [x] libpsl: MIT
- [x] libpst: GPL-2.0-or-later
...
- [x] libspectrum: GPL-2.0-or-later
...
- [ ] libstrophe: `{:any_of=>["GPL-3.0", "MIT"]}` (deprecated) [[homepage](https://strophe.im/libstrophe/)] [[head](https://github.com/strophe/libstrophe.git)] [[stable](https://github.com/strophe/libstrophe/archive/0.10.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libstrophe.rb)]
...
- [x] libunistring: `{:any_of=>["GPL-2.0-only", "LGPL-3.0-or-later"]}`
- [x] libunwind: MIT
- [x] libunwind-headers: APSL-2.0
...
- [x] libxml++@4: LGPL-2.1-or-later
- [x] libxml++@5: LGPL-2.1-or-later
- [x] libxml2: MIT
- [x] libxmlsec1: MIT
...
- [ ] libzzip: LGPL-2.0 (deprecated) [[homepage](https://github.com/gdraheim/zziplib)] [head] [[stable](https://github.com/gdraheim/zziplib/archive/v0.13.72.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/libzzip.rb)]
...
- [ ] link-grammar: LGPL-2.1 (deprecated) [[homepage](https://www.abisource.com/projects/link-grammar/)] [head] [[stable](https://www.abisource.com/downloads/link-grammar/5.8.1/link-grammar-5.8.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/link-grammar.rb)]
...
- [x] lldpd: ISC
- [x] llnode: MIT
- [x] llvm: `{"Apache-2.0"=>{:with=>"LLVM-exception"}}`
- [x] llvm@7: NCSA
- [x] llvm@8: NCSA
- [x] llvm@9: Apache-2.0
...
- [x] log4cplus: `{:all_of=>["Apache-2.0", "BSD-2-Clause"]}`
...
- [x] logcheck: GPL-2.0-only
- [x] logcli: Apache-2.0
- [ ] logrotate: GPL-2.0 (deprecated) [[homepage](https://github.com/logrotate/logrotate)] [head] [[stable](https://github.com/logrotate/logrotate/releases/download/3.18.0/logrotate-3.18.0.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/logrotate.rb)]
...
- [ ] loudmouth: LGPL-2.1 (deprecated) [[homepage](https://mcabber.com)] [[head](https://github.com/mcabber/loudmouth.git)] [[stable](https://mcabber.com/files/loudmouth/loudmouth-1.5.4.tar.bz2)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/loudmouth.rb)]
...
- [x] lttng-ust: `{:all_of=>["LGPL-2.1-only", "MIT", "GPL-2.0-only", "BSD-3-Clause", "BSD-2-Clause", "GPL-3.0-or-later"]}`
- [x] lua: MIT
- [x] lua@5.1: MIT
- [x] lua@5.3: MIT
- [x] luabind: MIT
- [x] luajit: MIT
- [x] luajit-openresty: MIT
- [x] luaradio: MIT
- [x] luarocks: MIT
- [x] luaver: MIT
- [x] luit: MIT
...
- [x] lzip: GPL-2.0-or-later
- [ ] lzlib [[homepage](https://www.nongnu.org/lzip/lzlib.html)] [head] [[stable](https://download.savannah.gnu.org/releases/lzip/lzlib/lzlib-1.12.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/lzlib.rb)]
- [x] lzo: GPL-2.0-or-later
...
- [x] mapnik: LGPL-2.1-or-later
- [ ] mapserver [[homepage](https://mapserver.org/)] [head] [[stable](https://download.osgeo.org/mapserver/mapserver-7.6.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/mapserver.rb)]
- [x] mariadb: GPL-2.0-only
- [x] mariadb-connector-c: LGPL-2.1-or-later
- [x] mariadb-connector-odbc: LGPL-2.1-or-later
...
- [x] mas: MIT
- [x] mask: MIT
- [x] masscan: AGPL-3.0-only
- [x] massdns: GPL-3.0-only
- [x] massren: MIT
- [x] mat2: LGPL-3.0-or-later
...
- [x] mda-lv2: GPL-3.0-or-later
- [x] mdbook: MPL-2.0
- [x] mdbtools: GPL-2.0-or-later
- [x] mdcat: MPL-2.0
- [x] mdds: MIT
...
- [x] midnight-commander: GPL-3.0-or-later
...
- [x] minbif: GPL-2.0-only
- [ ] minetest: LGPL-2.1 (deprecated) [[homepage](https://www.minetest.net/)] [[head](https://github.com/minetest/minetest.git)] [[stable](https://github.com/minetest/minetest/archive/5.4.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/minetest.rb)]
- [x] mingw-w64: ZPL-2.1
- [x] minica: MIT
- [x] minicom: GPL-2.0-or-later
...
- [x] minipro: GPL-3.0-or-later
- [x] minised: BSD-3-Clause
- [x] miniserve: MIT
- [x] minisign: ISC
- [x] miniupnpc: BSD-3-Clause
- [x] minizinc: MPL-2.0
...
- [ ] mk-configure [[homepage](https://github.com/cheusov/mk-configure)] [head] [[stable](https://downloads.sourceforge.net/project/mk-configure/mk-configure/mk-configure-0.36.0/mk-configure-0.36.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/mk-configure.rb)]
- [x] mkcert: BSD-3-Clause
- [x] mkclean: BSD-3-Clause
...
- [ ] mlkit: GPL-2.0 (deprecated) [[homepage](https://melsman.github.io/mlkit)] [[head](https://github.com/melsman/mlkit.git)] [[stable](https://github.com/melsman/mlkit/archive/v4.5.7.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/mlkit.rb)]
- [x] mlogger: BSD-4-Clause-UC
- [x] mlpack: `{:all_of=>["BSD-3-Clause", "MPL-2.0", "BSL-1.0", "MIT"]}`
- [x] mlt: LGPL-2.1-only
- [x] mlton: HPND
...
- [x] modman: Apache-2.0
- [x] modules: GPL-2.0-or-later
- [x] moe: GPL-2.0-or-later
- [x] mogenerator: MIT
- [x] molecule: MIT
...
- [ ] monit [[homepage](https://mmonit.com/monit/)] [head] [[stable](https://mmonit.com/monit/dist/monit-5.27.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/monit.rb)]
...
- [x] mpich: mpich2
- [x] mpir: GPL-3.0-or-later
- [x] mplayer: `{:all_of=>["GPL-2.0-only", "GPL-2.0-or-later"]}`
- [x] mplayershell: MIT
- [x] mpop: GPL-3.0-or-later
- [x] mps-youtube: GPL-3.0-or-later
- [x] mpssh: BSD-3-Clause
- [x] mpv: `cannot_represent`
- [x] mpw: GPL-3.0-or-later
...
- [x] mruby: MIT
- [x] mruby-cli: MIT
- [x] msc-generator: AGPL-3.0-or-later
...
- [x] mycli: BSD-3-Clause
- [x] mydumper: GPL-3.0-or-later
...
- [x] mypy: MIT
- [x] mysql: GPL-2.0-only
- [x] mysql++: LGPL-2.1-or-later
- [ ] mysql-client [[homepage](https://dev.mysql.com/doc/refman/8.0/en/)] [head] [[stable](https://cdn.mysql.com/Downloads/MySQL-8.0/mysql-boost-8.0.23.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/mysql-client.rb)]
- [ ] mysql-client@5.7 [[homepage](https://dev.mysql.com/doc/refman/5.7/en/)] [head] [[stable](https://cdn.mysql.com/Downloads/MySQL-5.7/mysql-boost-5.7.32.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/mysql-client@5.7.rb)]
- [ ] mysql-connector-c++ [[homepage](https://dev.mysql.com/downloads/connector/cpp/)] [head] [[stable](https://dev.mysql.com/get/Downloads/Connector-C++/mysql-connector-c++-8.0.23-src.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/mysql-connector-c++.rb)]
...
- [x] mysql@5.6: GPL-2.0-only
- [x] mysql@5.7: GPL-2.0-only
- [x] mysqltuner: GPL-3.0-or-later
...
- [x] name-that-hash: GPL-3.0-or-later
...
- [x] neko: MIT
- [x] neo4j: GPL-3.0-or-later
- [x] neofetch: MIT
- [x] neomutt: GPL-2.0-or-later
- [x] neon: LGPL-2.0-or-later
...
- [x] nettle: `{:any_of=>["GPL-2.0-or-later", "LGPL-3.0-or-later"]}`
...
- [ ] ngs: GPL-3.0 (deprecated) [[homepage](https://ngs-lang.org/)] [[head](https://github.com/ngs-lang/ngs.git)] [[stable](https://github.com/ngs-lang/ngs/archive/v0.2.11.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/ngs.rb)]
- [ ] ngspice [[homepage](https://ngspice.sourceforge.io/)] [[head](https://git.code.sf.net/p/ngspice/ngspice.git)] [[stable](https://downloads.sourceforge.net/project/ngspice/ng-spice-rework/34/ngspice-34.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/ngspice.rb)]
- [x] ngt: Apache-2.0
- [x] nickle: MIT
...
- [x] notmuch-mutt: GPL-3.0-or-later
- [x] noweb: Noweb
- [x] npth: LGPL-2.1-or-later
...
- [ ] ntl [[homepage](https://libntl.org)] [head] [[stable](https://libntl.org/ntl-11.4.4.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/ntl.rb)]
...
- [x] nu: Apache-2.0
- [ ] nu-smv [[homepage](https://nusmv.fbk.eu)] [head] [[stable](https://nusmv.fbk.eu/distrib/NuSMV-2.6.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/nu-smv.rb)]
- [x] nuclei: MIT
- [x] nudoku: GPL-3.0-or-later
- [x] nuget: MIT
- [x] num-utils: GPL-2.0-or-later
- [x] numactl: `{:all_of=>["GPL-2.0-only", "LGPL-2.1-only", :public_domain, :cannot_represent]}`
- [x] numcpp: MIT
...
- [x] oakc: Apache-2.0
- [x] oath-toolkit: `{:all_of=>["GPL-3.0-or-later", "LGPL-2.1-or-later"]}`
- [x] oauth2_proxy: MIT
...
- [x] ocaml: `{"LGPL-2.1-only"=>{:with=>"OCaml-LGPL-linking-exception"}}`
- [x] ocaml-findlib: MIT
- [ ] ocaml-num: LGPL-2.1 (deprecated) [[homepage](https://github.com/ocaml/num)] [head] [[stable](https://github.com/ocaml/num/archive/v1.4.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/ocaml-num.rb)]
- [x] ocaml-zarith: LGPL-2.0-only
...
- [x] oil: Apache-2.0
- [x] okteto: Apache-2.0
- [ ] ola: GPL-2.0 (deprecated) [[homepage](https://www.openlighting.org/ola/)] [[head](https://github.com/OpenLightingProject/ola.git)] [[stable](https://github.com/OpenLightingProject/ola/releases/download/0.10.8/ola-0.10.8.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/ola.rb)]
...
- [x] ooniprobe: BSD-3-Clause
- [x] opa: Apache-2.0
- [ ] opam: LGPL-2.1 (deprecated) [[homepage](https://opam.ocaml.org)] [[head](https://github.com/ocaml/opam.git)] [[stable](https://github.com/ocaml/opam/releases/download/2.0.8/opam-full-2.0.8.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/opam.rb)]
- [x] open-adventure: BSD-2-Clause
...
- [x] openalpr: AGPL-3.0-or-later
- [x] openapi-generator: Apache-2.0
- [x] openblas: BSD-3-Clause
- [x] opencascade: LGPL-2.1-only
...
- [ ] openkim-models [[homepage](https://openkim.org)] [head] [[stable](https://s3.openkim.org/archives/collection/openkim-models-2021-01-28.txz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/openkim-models.rb)]
- [x] openldap: OLDAP-2.8
- [ ] openlibm [[homepage](https://openlibm.org)] [head] [[stable](https://github.com/JuliaMath/openlibm/archive/v0.7.5.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/openlibm.rb)]
- [x] openmama: LGPL-2.1-only
- [x] openmodelica: GPL-3.0-only
...
- [x] openvdb: MPL-2.0
- [x] openvpn: `{"GPL-2.0-only"=>{:with=>"openvpn-openssl-exception"}}`
- [x] operator-sdk: Apache-2.0
- [x] ophcrack: GPL-2.0-or-later
- [x] optipng: Zlib
- [x] opus: BSD-3-Clause
...
- [x] oras: MIT
- [x] orbit: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.0-only"]}`
...
- [x] ortp: GPL-3.0-or-later
- [x] ory-hydra: Apache-2.0
- [x] osc: GPL-2.0-or-later
...
- [x] osi: EPL-1.0
- [x] osm: Apache-2.0
- [x] osm-gps-map: GPL-2.0-or-later
- [ ] osm-pbf: LGPL-3.0 (deprecated) [[homepage](https://wiki.openstreetmap.org/wiki/PBF_Format)] [head] [[stable](https://github.com/scrosby/OSM-binary/archive/v1.5.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/osm-pbf.rb)]
- [x] osm2pgrouting: GPL-2.0-or-later
- [x] osm2pgsql: GPL-2.0-only
- [x] osmcoastline: GPL-3.0-or-later
...
- [x] osmium-tool: GPL-3.0-or-later
...
- [x] ospray: Apache-2.0
- [x] osqp: Apache-2.0
- [x] osquery: `{:any_of=>["Apache-2.0", "GPL-2.0-only"]}`
...
- [x] p7zip: `{:all_of=>["LGPL-2.1-or-later", "GPL-2.0-or-later"]}`
- [x] pacapt: Fair
- [ ] pachi: GPL-2.0 (deprecated) [[homepage](https://pachi.or.cz/)] [[head](https://github.com/pasky/pachi.git)] [[stable](https://github.com/pasky/pachi/archive/pachi-12.60.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/pachi.rb)]
- [x] packer: MPL-2.0
...
- [x] pass-git-helper: LGPL-3.0-or-later
...
- [x] pcalc: GPL-3.0-or-later
- [x] pcapplusplus: Unlicense
- [x] pcb: GPL-2.0-or-later
...
- [x] pcl: BSD-3-Clause
- [x] pcre: BSD-3-Clause
- [x] pcre++: LGPL-2.1-only
- [x] pcre2: BSD-3-Clause
- [x] pcsc-lite: `{:all_of=>["BSD-3-Clause", "GPL-3.0-or-later", "ISC"]}`
- [x] pdal: BSD-3-Clause
...
- [x] peco: MIT
- [x] peg: MIT
- [x] peg-markdown: `{:any_of=>["GPL-2.0-or-later", "MIT"]}`
- [x] pegtl: MIT
...
- [x] percol: MIT
- [ ] percona-server [[homepage](https://www.percona.com)] [head] [[stable](https://www.percona.com/downloads/Percona-Server-8.0/Percona-Server-8.0.22-13/source/tarball/percona-server-8.0.22-13.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/percona-server.rb)]
- [x] percona-toolkit: `{:any_of=>["GPL-2.0-only", "Artistic-1.0-Perl"]}`
- [ ] percona-xtrabackup [[homepage](https://www.percona.com/software/mysql-database/percona-xtrabackup)] [head] [[stable](https://www.percona.com/downloads/Percona-XtraBackup-LATEST/Percona-XtraBackup-8.0.22-15/source/tarball/percona-xtrabackup-8.0.22-15.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/percona-xtrabackup.rb)]
...
- [ ] pgpool-ii [[homepage](https://www.pgpool.net/mediawiki/index.php/Main_Page)] [head] [[stable](https://www.pgpool.net/mediawiki/images/pgpool-II-4.2.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/pgpool-ii.rb)]
- [x] pgroonga: PostgreSQL
- [x] pgrouting: GPL-2.0-or-later
...
- [x] phoronix-test-suite: GPL-3.0-or-later
- [x] php: PHP-3.01
...
- [ ] phpmyadmin [[homepage](https://www.phpmyadmin.net)] [head] [[stable](https://files.phpmyadmin.net/phpMyAdmin/5.1.0/phpMyAdmin-5.1.0-all-languages.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/phpmyadmin.rb)]
- [x] phpstan: MIT
...
- [x] pillar: MIT
- [x] pilosa: Apache-2.0
- [x] pinboard-notes-backup: GPL-3.0-or-later
- [x] pinentry: GPL-2.0-only
- [x] pinentry-mac: `{:all_of=>["GPL-2.0-or-later", "GPL-3.0-or-later"]}`
...
- [ ] pioneer: GPL-3.0 (deprecated) [[homepage](https://pioneerspacesim.net/)] [[head](https://github.com/pioneerspacesim/pioneer.git)] [[stable](https://github.com/pioneerspacesim/pioneer/archive/20210203.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/pioneer.rb)]
...
- [x] pkcs11-helper: `{:any_of=>["BSD-3-Clause", "GPL-2.0-or-later"]}`
...
- [x] plenv: `{:any_of=>["Artistic-1.0-Perl", "GPL-1.0-or-later"]}`
...
- [x] pngcheck: `{:all_of=>["MIT", "GPL-2.0-or-later"]}`
...
- [x] podiff: GPL-3.0-or-later
- [x] podman: Apache-2.0
- [x] podofo: `{:all_of=>["LGPL-2.0-only", "GPL-2.0-only"]}`
- [x] poetry: MIT
...
- [x] prefixsuffix: GPL-2.0-or-later
...
- [ ] progress: GPL-3.0 (deprecated) [[homepage](https://github.com/Xfennec/progress)] [[head](https://github.com/Xfennec/progress.git)] [[stable](https://github.com/Xfennec/progress/archive/v0.16.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/progress.rb)]
...
- [x] pulseaudio: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later", "BSD-3-Clause"]}`
- [x] pulumi: Apache-2.0
- [x] pumba: Apache-2.0
- [x] pup: MIT
...
- [ ] puzzles [[homepage](https://www.chiark.greenend.org.uk/~sgtatham/puzzles/)] [[head](https://git.tartarus.org/simon/puzzles.git)] [[stable](https://www.chiark.greenend.org.uk/~sgtatham/puzzles/puzzles-20201208.84cb4c6.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/puzzles.rb)]
- [x] pv: Artistic-2.0
...
- [x] pyinstaller: GPL-2.0-or-later
...
- [x] pypy3: MIT
- [x] pyqt: GPL-3.0-only
- [x] pyqt-3d: GPL-3.0-only
- [x] pyqt-builder: `{:any_of=>["GPL-2.0-only", "GPL-3.0-only"]}`
- [x] pyqt-networkauth: GPL-3.0-only
- [x] pyqt@5: GPL-3.0-only
- [x] pyside: `{:all_of=>["GFDL-1.3-only", "GPL-2.0-only", "GPL-3.0-only", "LGPL-3.0-only"]}`
- [x] pyside@2: `{:all_of=>["GFDL-1.3-only", "GPL-2.0-only", "GPL-3.0-only", "LGPL-3.0-only"]}`
- [x] python-markdown: BSD-3-Clause
- [x] python-tabulate: MIT
...
- [x] qbs: `cannot_represent`
- [x] qca: LGPL-2.1-or-later
- [x] qcachegrind: GPL-2.0-or-later
- [x] qcli: GPL-3.0-or-later
...
- [x] qsoas: GPL-2.0-only
- [x] qstat: Artistic-2.0
- [x] qt: `{:all_of=>["GFDL-1.3-only", "GPL-2.0-only", "GPL-3.0-only", "LGPL-2.1-only", "LGPL-3.0-only"]}`
- [x] qt-libiodbc: `{:all_of=>["GPL-2.0-only", "GPL-3.0-only", "LGPL-2.1-only", "LGPL-3.0-only"]}`
- [x] qt-mariadb: `{:all_of=>["LGPL-2.1-only", "LGPL-3.0-only"]}`
- [x] qt-mysql: `{:all_of=>["LGPL-2.1-only", "LGPL-3.0-only"]}`
- [x] qt-percona-server: `{:all_of=>["LGPL-2.1-only", "LGPL-3.0-only"]}`
- [x] qt-postgresql: `{:all_of=>["GFDL-1.3-only", "GPL-2.0-only", "GPL-3.0-only", "LGPL-2.1-only", "LGPL-3.0-only"]}`
- [x] qt-unixodbc: `{:all_of=>["GPL-2.0-only", "GPL-3.0-only", "LGPL-2.1-only", "LGPL-3.0-only"]}`
- [x] qt@5: `{:all_of=>["GFDL-1.3-only", "GPL-2.0-only", "GPL-3.0-only", "LGPL-2.1-only", "LGPL-3.0-only"]}`
...
- [x] qwt: `{"LGPL-2.1-only"=>{:with=>"Qwt-exception-1.0"}}`
...
- [x] rain: Apache-2.0
- [x] rainbarf: `{:any_of=>["Artistic-1.0-Perl", "GPL-1.0-or-later"]}`
...
- [ ] restview: GPL-3.0 (deprecated) [[homepage](https://mg.pov.lt/restview/)] [head] [[stable](https://files.pythonhosted.org/packages/e6/40/b4ef5c90297b9d37248090b9fde3a9aa1ef25e87ebd17b363760fec39a78/restview-2.9.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/restview.rb)]
- [x] resty: MIT
...
- [x] rocksdb: `{:any_of=>["GPL-2.0-only", "Apache-2.0"]}`
...
- [x] rtmpdump: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later"]}`
...
- [x] rtptools: BSD-3-Clause
- [x] rttr: MIT
- [x] rtv: MIT
- [x] rubberband: GPL-2.0-or-later
- [x] ruby: Ruby
- [x] ruby-build: MIT
...
- [ ] s-nail [[homepage](https://www.sdaoden.eu/code.html)] [head] [[stable](https://www.sdaoden.eu/downloads/s-nail-14.9.22.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/s-nail.rb)]
- [x] s-search: MIT
...
- [ ] saxon [[homepage](https://saxon.sourceforge.io)] [head] [[stable](https://downloads.sourceforge.net/project/saxon/Saxon-HE/10/Java/SaxonHE10-3J.zip)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/saxon.rb)]
...
- [x] screenresolution: GPL-2.0-only
...
- [x] sd: MIT
- [x] sdb: MIT
- [x] sdcc: `{:all_of=>["GPL-2.0-only", "GPL-3.0-only", :public_domain, "Zlib"]}`
...
- [x] shared-mime-info: GPL-2.0-only
...
- [x] shellz: GPL-3.0-only
- [x] shfmt: BSD-3-Clause
- [x] shibboleth-sp: Apache-2.0
- [x] ship: Apache-2.0
...
- [x] sic: MIT
- [x] sickle: MIT
- [ ] siege: GPL-3.0 (deprecated) [[homepage](https://www.joedog.org/siege-home/)] [head] [[stable](http://download.joedog.org/siege/siege-4.0.8.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/siege.rb)]
- [x] sift: GPL-3.0-only
...
- [ ] simgrid [[homepage](https://simgrid.org/)] [head] [[stable](https://framagit.org/simgrid/simgrid/uploads/98ec9471211bba09aa87d7866c9acead/simgrid-3.26.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/simgrid.rb)]
- [x] simh: MIT
...
- [ ] singular: GPL-2.0 (deprecated) [[homepage](https://www.singular.uni-kl.de/)] [[head](https://github.com/Singular/Singular.git)] [[stable](https://service.mathematik.uni-kl.de/ftp/pub/Math/Singular/src/4-2-0/singular-4.2.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/singular.rb)]
...
- [ ] sleuthkit: GPL-2.0 (deprecated) [[homepage](https://www.sleuthkit.org/)] [head] [[stable](https://github.com/sleuthkit/sleuthkit/releases/download/sleuthkit-4.10.1/sleuthkit-4.10.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/sleuthkit.rb)]
- [x] slimerjs: MPL-2.0
- [x] sloc: MIT
- [x] sloccount: GPL-2.0-or-later
...
- [x] smake: GPL-2.0-only
- [x] smali: BSD-3-Clause
- [x] smartmontools: GPL-2.0-or-later
...
- [x] so: MIT
- [ ] socat: GPL-2.0 (deprecated) [[homepage](http://www.dest-unreach.org/socat/)] [head] [[stable](http://www.dest-unreach.org/socat/download/socat-1.7.4.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/socat.rb)]
- [x] soci: BSL-1.0
...
- [ ] sollya [[homepage](https://www.sollya.org/)] [head] [[stable](https://gforge.inria.fr/frs/download.php/file/37749/sollya-7.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/sollya.rb)]
- [x] solr: Apache-2.0
...
- [x] sonarqube-lts: LGPL-3.0-or-later
- [x] sonic: MPL-2.0
...
- [x] spaceman-diff: MIT
- [x] spack: `{:any_of=>["Apache-2.0", "MIT"]}`
- [x] spades: GPL-2.0-only
...
- [x] spdlog: MIT
- [x] spdylay: MIT
- [ ] speech-tools [[homepage](http://festvox.org/docs/speech_tools-2.4.0/)] [[head](https://github.com/festvox/speech_tools.git)] [[stable](http://festvox.org/packed/festival/2.5/speech_tools-2.5.0-release.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/speech-tools.rb)]
- [x] speedread: MIT
...
- [ ] squid: GPL-2.0 (deprecated) [[homepage](http://www.squid-cache.org/)] [[head](lp:squid)] [[stable](http://www.squid-cache.org/Versions/v4/squid-4.14.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/squid.rb)]
- [x] squirrel: MIT
- [x] sratom: ISC
- [x] sratoolkit: `{:all_of=>[:public_domain, "GPL-3.0-or-later", "MIT"]}`
- [x] src: BSD-2-Clause
...
- [ ] sshguard [[homepage](https://www.sshguard.net/)] [[head](https://bitbucket.org/sshguard/sshguard.git)] [[stable](https://downloads.sourceforge.net/project/sshguard/sshguard/2.4.2/sshguard-2.4.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/sshguard.rb)]
...
- [ ] sstp-client: GPL-2.0 (deprecated) [[homepage](https://sstp-client.sourceforge.io/)] [head] [[stable](https://downloads.sourceforge.net/project/sstp-client/sstp-client/sstp-client-1.0.14.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/sstp-client.rb)]
- [x] st: MIT
- [x] standardese: MIT
- [x] stanford-corenlp: GPL-2.0-or-later
- [x] stanford-ner: GPL-2.0-or-later
- [x] stanford-parser: GPL-2.0-or-later
...
- [x] starship: ISC
- [x] startup-notification: LGPL-2.0-or-later
- [x] staticcheck: MIT
- [x] statik: MIT
- [x] stdman: MIT
...
- [x] step: Apache-2.0
- [x] stern: Apache-2.0
- [ ] stgit: GPL-2.0 (deprecated) [[homepage](https://stacked-git.github.io)] [[head](https://github.com/stacked-git/stgit.git)] [[stable](https://github.com/stacked-git/stgit/releases/download/v1.0/stgit-1.0.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/stgit.rb)]
...
- [ ] stm32flash [[homepage](https://sourceforge.net/projects/stm32flash/)] [head] [[stable](https://downloads.sourceforge.net/project/stm32flash/stm32flash-0.6.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/stm32flash.rb)]
...
- [x] subfinder: MIT
- [x] subliminal: MIT
- [x] subnetcalc: GPL-3.0-or-later
- [x] subversion: Apache-2.0
- [x] subversion@1.8: Apache-2.0
- [x] suil: ISC
- [x] suite-sparse: `{:all_of=>["BSD-3-Clause", "LGPL-2.1-or-later", "GPL-2.0-or-later", "Apache-2.0", "GPL-3.0-only", {:any_of=>["LGPL-3.0-or-later", "GPL-2.0-or-later"]}]}`
...
- [x] syncthing: MPL-2.0
- [x] synfig: GPL-3.0-or-later
- [x] synscan: GPL-2.0-or-later
- [x] syntaxerl: MIT
...
- [x] tag: MIT
- [ ] taglib: LGPL-2.1 (deprecated) [[homepage](https://taglib.org/)] [[head](https://github.com/taglib/taglib.git)] [[stable](https://taglib.github.io/releases/taglib-1.12.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/taglib.rb)]
- [x] tailor: MIT
...
- [x] tbb: Apache-2.0
- [x] tbox: Apache-2.0
- [x] tcc: LGPL-2.0-or-later
- [x] tccutil: GPL-2.0-or-later
- [x] tcl-tk: TCL
- [x] tclap: MIT
- [x] tcpdump: BSD-3-Clause
- [ ] tcpflow: GPL-3.0 (deprecated) [[homepage](https://github.com/simsong/tcpflow)] [[head](https://github.com/simsong/tcpflow.git)] [[stable](https://downloads.digitalcorpora.org/downloads/tcpflow/tcpflow-1.6.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/tcpflow.rb)]
- [x] tcping: MIT
...
- [ ] texlab: GPL-3.0 (deprecated) [[homepage](https://texlab.netlify.com/)] [[head](https://github.com/latex-lsp/texlab.git)] [[stable](https://github.com/latex-lsp/texlab/archive/v2.2.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/texlab.rb)]
- [x] texmath: GPL-2.0-or-later
- [x] textql: MIT
- [x] tfenv: MIT
- [x] tflint: MPL-2.0
- [x] tfsec: MIT
...
- [x] thrax: Apache-2.0
- [x] threadweaver: LGPL-2.0-or-later
- [x] threemux: MIT
- [x] thrift: Apache-2.0
...
- [x] tor: `{:all_of=>["BSD-2-Clause", "BSD-3-Clause", "MIT", "NCSA"]}`
...
- [x] transmission-cli: `{:any_of=>["GPL-2.0-only", "GPL-3.0-only"]}`
- [x] trash: MIT
- [x] trash-cli: GPL-2.0-or-later
- [x] travis: MIT
...
- [x] ttf2eot: `{:any_of=>["LGPL-2.0-or-later", "BSD-2-Clause"]}`
...
- [x] u-boot-tools: `{:all_of=>["GPL-2.0-only", "GPL-2.0-or-later", "BSD-3-Clause"]}`
...
- [ ] uchardet [[homepage](https://www.freedesktop.org/wiki/Software/uchardet/)] [[head](https://gitlab.freedesktop.org/uchardet/uchardet.git)] [[stable](https://www.freedesktop.org/software/uchardet/releases/uchardet-0.0.7.tar.xz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/uchardet.rb)]
- [x] ucl: GPL-2.0-or-later
- [x] ucloud: Apache-2.0
...
- [ ] urh: GPL-3.0 (deprecated) [[homepage](https://github.com/jopohl/urh)] [[head](https://github.com/jopohl/urh.git)] [[stable](https://files.pythonhosted.org/packages/ea/ec/f091b8dd7636c1999a0cef0d6d0c5fe011e12e9a4c1809526bfa58c39197/urh-2.9.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/urh.rb)]
- [x] uriparser: BSD-3-Clause
- [x] urlview: GPL-2.0-or-later
...
- [ ] userspace-rcu [[homepage](https://liburcu.org)] [head] [[stable](https://lttng.org/files/urcu/userspace-rcu-0.12.2.tar.bz2)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/userspace-rcu.rb)]
- [x] utf8cpp: BSL-1.0
- [x] utf8proc: `{:all_of=>["MIT", "Unicode-DFS-2015"]}`
- [x] util-linux: `{:all_of=>["BSD-3-Clause", "BSD-4-Clause-UC", "GPL-2.0-only", "GPL-2.0-or-later", "GPL-3.0-or-later", "LGPL-2.1-or-later", :public_domain]}`
- [x] util-macros: MIT
...
- [x] vapor: MIT
- [x] vapoursynth: LGPL-2.1-or-later
- [x] vapoursynth-imwri: LGPL-2.1-or-later
- [x] vapoursynth-ocr: ISC
- [x] vapoursynth-sub: ISC
...
- [x] vc: BSD-3-Clause
- [ ] vc4asm [[homepage](http://maazl.de/project/vc4asm/doc/index.html)] [head] [[stable](https://github.com/maazl/vc4asm/archive/V0.3.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/vc4asm.rb)]
...
- [ ] vorbis-tools [[homepage](https://github.com/xiph/vorbis-tools)] [head] [[stable](https://downloads.xiph.org/releases/vorbis/vorbis-tools-1.4.2.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/vorbis-tools.rb)]
...
- [x] wasm3: MIT
- [x] wasmer: MIT
- [x] watch: `{:all_of=>["GPL-2.0-or-later", "LGPL-2.1-or-later"]}`
- [x] watch-sim: MIT
...
- [x] willgit: MIT
- [x] wimlib: GPL-3.0-or-later
- [x] winetricks: LGPL-2.1-or-later
...
- [x] wireguard-go: MIT
- [x] wireguard-tools: GPL-2.0-only
...
- [x] x86_64-elf-binutils: GPL-3.0-or-later
...
- [x] xapian: GPL-2.0-or-later
- [x] xaric: GPL-2.0-or-later
...
- [x] xcb-proto: MIT
- [x] xcb-util: MIT
- [x] xcb-util-cursor: X11
- [x] xcb-util-image: X11
- [x] xcb-util-keysyms: X11
- [x] xcb-util-renderutil: `{:all_of=>["X11", "HPND-sell-variant"]}`
- [x] xcb-util-wm: X11
- [x] xcbeautify: MIT
- [x] xcenv: MIT
- [x] xcinfo: MIT
...
- [x] xmlrpc-c: BSD-3-Clause
- [x] xmlsectool: Apache-2.0
...
- [x] xorgproto: MIT
- [x] xorgrgb: MIT
- [x] xorriso: GPL-2.0-or-later
- [x] xpa: MIT
- [ ] xpdf: GPL-2.0 (deprecated) [[homepage](https://www.xpdfreader.com/)] [head] [[stable](https://dl.xpdfreader.com/xpdf-4.03.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/xpdf.rb)]
- [x] xplanet: GPL-2.0-or-later
...
- [x] xray: `{:all_of=>["MPL-2.0", "CC-BY-SA-4.0"]}`
...
- [ ] xtail [[homepage](https://unicom.crosenthal.com/sw/xtail)] [head] [[stable](https://unicom.crosenthal.com/files/xtail-2.1.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/xtail.rb)]
...
- [x] xtrans: MIT
- [x] xvid: GPL-2.0-or-later
- [x] xxh: BSD-2-Clause
- [x] xxhash: BSD-2-Clause
- [x] xz: `{:all_of=>[:public_domain, "LGPL-2.1-or-later", "GPL-2.0-or-later", "GPL-3.0-or-later"]}`
...
- [ ] ydcv: GPL-3.0 (deprecated) [[homepage](https://github.com/felixonmars/ydcv)] [[head](https://github.com/felixonmars/ydcv.git)] [[stable](https://files.pythonhosted.org/packages/1f/29/17124ebfdea8d810774977474a8652018c04c4a6db1ca413189f7e5b9d52/ydcv-0.7.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/ydcv.rb)]
...
- [x] zeromq: `{"LGPL-3.0-or-later"=>{:with=>"LGPL-3.0-linking-exception"}}`
- [x] zig: MIT
- [x] zile: GPL-3.0-or-later
- [x] zim: GPL-2.0-or-later
- [x] zimg: WTFPL
...
- [x] zopfli: Apache-2.0
- [x] zorba: Apache-2.0
- [ ] zork [[homepage](https://github.com/devshane/zork)] [[head](https://github.com/devshane/zork.git)] [[stable](https://github.com/devshane/zork/archive/v1.0.3.tar.gz)] [[formula](https://github.com/Homebrew/homebrew-core/blob/master/Formula/zork.rb)]
- [x] zoxide: MIT
- [x] zpaq: Unlicense
- [x] zplug: MIT
- [x] zrepl: MIT
...
- [x] zsh-navigation-tools: `{:any_of=>["GPL-3.0-only", "MIT"]}`
